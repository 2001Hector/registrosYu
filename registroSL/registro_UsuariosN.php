        ...
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-6">
            ...
            <form method="POST" action="">
                ...
                <div class="mb-6">
                    ...
                    <button type="button" id="addCustomFieldBtn" class="mt-2 px-4 py-2 bg-blue-500 text-white rounded-lg">
                ...
                <div class="flex justify-end gap-4">
                    <button type="reset" class="px-6 py-2 bg-gray-500 text-white rounded-lg">
                        <i class="fas fa-undo mr-1"></i> Limpiar
                    </button>
                    <button type="submit" name="registrar" class="px-6 py-2 bg-green-500 text-white rounded-lg">
            ...
            addBtn.addEventListener('click', function() {
                const fieldHtml = `
                    <div class="custom-field-group mb-4 p-4 border rounded-lg bg-gray-50">
                        ...
                        <button type="button" class="mt-2 px-3 py-1 bg-red-500 text-white rounded-lg remove-field">
