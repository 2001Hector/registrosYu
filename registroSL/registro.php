...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $fecha = mysqli_real_escape_string($conexion, $_POST['fecha']); // Cambiado: ahora usa la fecha del formulario
        ...
        if (in_array($extension, $formatosBloqueados)) {
            ...
            if ($ancho >= $alto) {
                ...
                if (move_uploaded_file($ruta_temporal, $ruta_final)) {
                    ...
                    $fecha_imagen = $fecha; // Usamos la misma fecha del formulario para la imagen
